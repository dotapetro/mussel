let websocketStringMessageType = 0;
let websocketIntMessageType = 1;
let websocketBoolMessageType = 2;
let websocketJSONMessageType = 4;
let websocketMessagePrefix = "iris-websocket-message:";
let websocketMessageSeparator = ";";
let websocketMessagePrefixLen = websocketMessagePrefix.length;
